...
/***/ function(module, exports, __webpack_require__) {
	...
	var DOMProperty = __webpack_require__(17);
	var ReactDOMComponentTree = __webpack_require__(5);
	var ReactDOMInstrumentation = __webpack_require__(142);
	var ReactInstrumentation = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var btoa = (typeof window !== 'undefined' && window.btoa) || __webpack_require__(94);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = React.createClass({
	  ...
	  callAPI: function (searchItem) {
	    axios.get('https://en.wikipedia.org/w/api.php?action=opensearch&format=json&search=' + searchItem).then(function (response) {
	    ...
	    $.ajax({
	      type: 'GET',
	      dataType: 'jsonp',
	      url: 'https://en.wikipedia.org/w/api.php?action=opensearch&format=json&search=' + searchItem,
	      ...
	      error: function(error) {
	        console.log('error:' + error).bind(this);
	      }
	    });
	    */
	    this.setState({
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement('input', { id: 'searchbar', placeholder: 'search...', onChange: this.handleChange, value: this.state.value }),
	        React.createElement('input', { id: 'searchsubmit', type: 'submit' })
	      ),
	      React.createElement(RandomArticle, null),
	      React.createElement(ResultsList, { results: this.state.searchResults })
	    );
	  }
	});
	...
	var ResultsList = React.createClass({
	  ...
	  render: function () {
	    let result = this.props.results[1].map((item, idx) => {
	      return React.createElement(SingleResult, { key: idx, title: this.props.results[1][idx], info: this.props.results[2][idx], url: this.props.results[3][idx] });
	    });
	    return React.createElement(
	      'div',
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      React.createElement(
	        'p',
	        null,
	        'A bryantheastronaut Production'
	      )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOMUnknownPropertyDevtool = __webpack_require__(148);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (process.env.NODE_ENV !== 'production') {
	  ...
	  var ReactNativeOperationHistoryDevtool = __webpack_require__(158);
	  var ReactComponentTreeDevtool = __webpack_require__(130);
